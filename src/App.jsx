...
function SwipeCompareMap({ urlA, urlB, yearA, yearB, isPredictedA, isPredictedB }) {
  ...
  return (
    <div ref={wrapRef} style={{flex:1,position:"relative",background:"#020810",borderRadius:"var(--radius)",border:"1px solid var(--border)",overflow:"hidden",minHeight:0,userSelect:"none",touchAction:"none"}}>
      <MapContainer bounds={KATHMANDU_BOUNDS} maxBounds={KATHMANDU_BOUNDS} maxBoundsViscosity={0.8} zoomControl={false} scrollWheelZoom style={{height:"100%",width:"100%"}}>
              ...
              {compareMode==="split"&&(
                <div className="split-wrap">
                  <div className="split-half">
                    <MapContainer bounds={liveBounds} maxBounds={liveBounds} maxBoundsViscosity={0.8} zoomControl={false} scrollWheelZoom style={{height:"100%",width:"100%"}}>
                      <ZoomControl position="bottomright"/>
                      <TileLayer url={CARTO_DARK} attribution={CARTO_ATTR}/>
